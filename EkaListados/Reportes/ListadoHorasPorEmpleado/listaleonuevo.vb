...
Public Class listaleonuevo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EkaListados.listaleonuevo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlistaleonuevo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listaleonuevo = New listaleonuevo()
        rpt.Site = Me.Site
        Return rpt
    End Function
